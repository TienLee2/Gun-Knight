...
Shader "Polygonmaker/Basic-PBR"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 clampResult56 = clamp( ( ( ( _ColorR * tex2DNode27.r ) + ( 1.0 - tex2DNode27.r ) ) * ( ( _ColorG * tex2DNode27.g ) + ( 1.0 - tex2DNode27.g ) ) * ( ( _ColorB * tex2DNode27.b ) + ( 1.0 - tex2DNode27.b ) ) * ( _Color * tex2D( _MainTex, uv_MainTex ) ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
...
/*ASEBEGIN
Version=18800
8.666667;150.6667;1850;1172;1960.674;974.6874;1.793937;True;True
...
Node;AmplifyShaderEditor.ClampOpNode;56;231.5171,-246.3491;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=7198E713052FA509ACB87F21420BBECB802CB25E