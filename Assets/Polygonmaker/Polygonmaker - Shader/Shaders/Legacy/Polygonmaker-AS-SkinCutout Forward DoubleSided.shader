...
Shader "Polygonmaker/SkinCutout - TwoSide - Forward"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float4 clampResult52 = clamp( ( ( ( _ColorR * tex2DNode27.r ) + ( 1.0 - tex2DNode27.r ) ) * ( ( _ColorG * tex2DNode27.g ) + ( 1.0 - tex2DNode27.g ) ) * ( ( _ColorB * tex2DNode27.b ) + ( 1.0 - tex2DNode27.b ) ) * ( ( _SkinHairColor * fresnelNode14 * tex2DNode25.b ) + ( _Color * tex2DNode3 ) ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
			o.Albedo = clampResult52.rgb;
...
/*ASEBEGIN
Version=18800
8.666667;150.6667;1850;1172;2058.816;1075.596;2.161006;True;True
...
Node;AmplifyShaderEditor.ClampOpNode;52;534.3916,-332.2097;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=412C45C557BD9B30AF74A7B98ED13042D142F12E