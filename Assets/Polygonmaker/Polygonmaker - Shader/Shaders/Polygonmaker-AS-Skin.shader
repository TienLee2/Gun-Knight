...
Shader "Polygonmaker/Skin"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float4 clampResult56 = clamp( ( ( ( _ColorR * tex2DNode27.r ) + ( 1.0 - tex2DNode27.r ) ) * ( ( _ColorG * tex2DNode27.g ) + ( 1.0 - tex2DNode27.g ) ) * ( ( _ColorB * tex2DNode27.b ) + ( 1.0 - tex2DNode27.b ) ) * ( ( _SkinHairColor * fresnelNode14 * tex2DNode25.b ) + ( _Color * tex2D( _MainTex, uv_MainTex ) ) ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
...
/*ASEBEGIN
Version=18800
8.666667;150.6667;1850;1172;2799.071;1830.846;2.852857;True;True
...
Node;AmplifyShaderEditor.ClampOpNode;56;597.2516,-310.1434;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=C563D2DCCF7C37390206A088673994782525B523