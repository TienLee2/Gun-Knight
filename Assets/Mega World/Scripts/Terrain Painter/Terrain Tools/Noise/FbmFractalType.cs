...
namespace MegaWorld
{
    ...
    public class FbmFractalType : FractalType<FbmFractalType>
    {
        ...
        {
            name = "Fbm",
            templatePath = "Assets/Mega World/Shaders/Terrain Tools/NoiseLib/Templates/FractalFbm.noisehlsltemplate",
            ...
            {
                "Assets/Mega World/Shaders/Terrain Tools/NoiseLib/NoiseCommon.hlsl"
            }
        };
