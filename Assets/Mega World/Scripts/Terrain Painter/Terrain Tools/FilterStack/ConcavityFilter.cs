    ...
    public class ConcavityFilter : Filter 
    {
        ...
        Texture2D GetRemapTexture() 
        {
            if (_concavityRemapTex == null) 
            {
                ...
                Utility.AnimationCurveToRenderTexture(ConcavityRemapCurve, ref _concavityRemapTex);
            }
        ...
        public override void DoGUI(Rect rect, int index)
        {
            ...
            if(EditorGUI.EndChangeCheck()) {
                Vector2 range = Utility.AnimationCurveToRenderTexture(ConcavityRemapCurve, ref _concavityRemapTex);
            }
        }
