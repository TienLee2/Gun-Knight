...
{
    [Serializable]
    public class HeightNoiseFilter : Filter 
    {
        ...
        public void SetMaterial(Material cs, FilterContext fc, int index)
        {
            if(index == 0)
            {
            ...
            cs.SetFloat("_ClampMinHeight", fc.PainterVariables.terrainUnderCursor.transform.position.y);
            cs.SetFloat("_ClampMaxHeight", fc.PainterVariables.terrainUnderCursor.terrainData.size.y + fc.PainterVariables.terrainUnderCursor.transform.position.y);
