...
namespace MegaWorld
{
    ...
    public class CollisionCheck
    {
        ...
        {
			RaycastHit hitInfo;
			if (Physics.BoxCast(new Vector3(position.x, position.y + MegaWorldPath.AdvancedSettings.EditorSettings.raycastSettings.SpawnCheckOffset, position.z), extents, 
				Vector3.down, out hitInfo, Quaternion.Euler(0f, rotation, 0f), MegaWorldPath.AdvancedSettings.EditorSettings.raycastSettings.SpawnCheckOffset + 1000f, checkCollisionLayers))
            {
                return true;
            }
