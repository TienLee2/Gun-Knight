...
namespace MegaWorld.PrecisePlace
{
    public static class AxisAlignment
    {
        ...
        public static void AlignObjectAxis(GameObject gameObject, CoordinateSystemAxis alignmentAxis, Vector3 destinationAxis, float normalWeight)
        {
            Transform objectTransform = gameObject.transform;
            Quaternion alignRotation = CalculateRotationQuaternionForAxisAlignment(objectTransform.rotation, alignmentAxis, destinationAxis);

            objectTransform.rotation = Quaternion.Lerp(objectTransform.rotation, alignRotation, normalWeight);
        }
