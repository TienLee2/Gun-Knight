...
namespace MegaWorld
{
    public static class BrushEraseToolVisualisation 
    {
        ...
        public static FilterStack GetCurrentMaskFilter()
        {
            ...
            {
                return MegaWorldPath.DataPackage.SelectedVariables.SelectedProtoGameObject.EraseMaskFilterStack;
            }
            if(MegaWorldPath.DataPackage.SelectedVariables.HasOneSelectedProtoTerrainDetail())
            {
    		    return MegaWorldPath.DataPackage.SelectedVariables.SelectedProtoTerrainDetail.EraseMaskFilterStack;
            }
            if(MegaWorldPath.DataPackage.SelectedVariables.HasOneSelectedProtoQuadroItem())
            {
                return MegaWorldPath.DataPackage.SelectedVariables.SelectedProtoQuadroItem.EraseMaskFilterStack;
            }
