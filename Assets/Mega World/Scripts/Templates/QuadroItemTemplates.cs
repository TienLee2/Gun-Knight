...
namespace MegaWorld
{
    public static class QuadroItemTemplates 
    {
    	public static void ApplyBigTreesTemplate(Type typeOfMegaWorld, PrototypeQuadroItem proto)
    	{
    	...
    	public static void ApplySmallTreesTemplate(Type typeOfMegaWorld, PrototypeQuadroItem proto)
    	{
            TransformComponentsStack transformComponentsStack = proto.TransformComponentsStack;
            FilterStack  maskFilterStack = proto.MaskFilterStack;
            OverlapCheckSettings overlapCheckSettings = proto.OverlapCheckSettings;
    	...
    	public static void ApplyBigCliffsTemplate(Type typeOfMegaWorld, PrototypeQuadroItem proto)
    	{
            TransformComponentsStack transformComponentsStack = proto.TransformComponentsStack;
            FilterStack  maskFilterStack = proto.MaskFilterStack;
            OverlapCheckSettings overlapCheckSettings = proto.OverlapCheckSettings;
    	...
    	public static void ApplySmallCliffsTemplate(Type typeOfMegaWorld, PrototypeQuadroItem proto)
    	{
            TransformComponentsStack transformComponentsStack = proto.TransformComponentsStack;
            FilterStack  maskFilterStack = proto.MaskFilterStack;
            OverlapCheckSettings overlapCheckSettings = proto.OverlapCheckSettings;
    	...
    	public static void ApplyRocksTemplate(Type typeOfMegaWorld, PrototypeQuadroItem proto)
    	{
            TransformComponentsStack transformComponentsStack = proto.TransformComponentsStack;
            FilterStack  maskFilterStack = proto.MaskFilterStack;
            OverlapCheckSettings overlapCheckSettings = proto.OverlapCheckSettings;
