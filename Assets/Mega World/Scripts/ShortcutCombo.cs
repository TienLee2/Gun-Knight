...
namespace MegaWorld
{
    ...
    public class ShortcutCombo
    {
        ...
        public bool IsActiveAllKeys(KeyboardButtonStates keyButtonStates)
        {            
        ...
        public bool IsActive(KeyboardButtonStates keyButtonStates, bool checkForPossibleOverlaps = true)
        {
            foreach(KeyCode key in _keys)
            {
