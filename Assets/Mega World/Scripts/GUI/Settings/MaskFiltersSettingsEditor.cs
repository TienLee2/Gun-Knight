			...
			if(maskFiltersSettingsFoldout)
			{
				...
				switch (brushMaskFiltersSettings.ColorSpace)
				{
					case ColorSpaceForBrushMaskFilter.СustomColor:
					{
						...
						brushMaskFiltersSettings.EnableStripe = CustomEditorGUI.Toggle(new GUIContent("Enable Brush Stripe"), brushMaskFiltersSettings.EnableStripe);
				...
				brushMaskFiltersSettings.EnableDefaultPreviewMaterial = CustomEditorGUI.Toggle(new GUIContent("Enable Default Brush Preview Material"), brushMaskFiltersSettings.EnableDefaultPreviewMaterial);
