...
namespace MegaWorld
{
    public static class DrawHandles 
    {
        ...
        public static void DrawXYZCross(RaycastInfo hit, Vector3 upwards, Vector3 right, Vector3 forward)
		{
			float handleSize = HandleUtility.GetHandleSize (hit.hitInfo.point) * 0.5f;

			Handles.color = Color.green;
            Handles.DrawAAPolyLine(3, hit.hitInfo.point + upwards * handleSize, hit.hitInfo.point + upwards * -handleSize * 0.2f);
			Handles.color = Color.red;
            Handles.DrawAAPolyLine(3, hit.hitInfo.point + right * handleSize, hit.hitInfo.point + right * -handleSize * 0.2f);
			Handles.color = Color.blue;
            Handles.DrawAAPolyLine(3, hit.hitInfo.point + forward * handleSize, hit.hitInfo.point + forward * -handleSize * 0.2f);
		}
